...
1. Installing the [JavaScript SDK](/integration/javascript-sdk) on your website to collect the web activity
2. Integrating the Rimdian API to sync existing customer data
3. Configuring apps to interconnect your digital marketing ecosystem (Google Ads, Facebook Ads...)

## For Shopify

The [Shopify integration](/integration/shopify) is prettry straightforward.
