...
Your response to the webhook allows you to:
...
- Return a list of data items to import (optional)
- Delay the next request (optional), useful if you interact with external systems that have rate limits like the Amazon Seller API
