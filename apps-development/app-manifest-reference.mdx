...
<ParamField path="app_tables" type="array">
    **App tables** - An array of extra tables that your app can add to the database. Example: `[{ "name": "table_1", "description": "Example of extra table", "shard_key": ["id"], "unique_key": ["id"], "sort_key": ["created_at"], "columns": [{ "name": "id", "type": "varchar", "size": 64, "description": "id", "is_required": true }] }]`.
</ParamField>
...
<ParamField path="shard_key" type="array">
    **Shard key** - An array of columns that should be used as the shard key. Example: `["id"]`.
</ParamField>

<ParamField path="unique_key" type="array">
    **Unique key** - An array of columns that should be used as the unique key. Example: `["id"]`.
</ParamField>

<ParamField path="sort_key" type="array">
    **Sort key** - An array of columns that should be used as the sort key. Example: `["created_at"]`.
</ParamField>
...
<ParamField path="is_required" type="boolean">
    **Is required** - Whether the column is required. Example: `true`.
</ParamField>
