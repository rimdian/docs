...
Example: if the average "time to conversion" of a customer journey is 30 days, you won't know the real performance of a marketing campaign after 30 days (+ some more time to let the cross-device reconciliation do its work).
