...
Want to take it to the next level? [create your own app](/apps-development/getting-started) to customize the platform to your needs.

## Installation

To get started with Rimdian, you can either:

- [Deploy Rimdian on-premise](/on-premise-deployment/checklist) & keep full control of your database & infrastructure
- [Subscribe to the cloud version](https://www.rimdian.com) & let us handle the infrastructure for you
